...
public class SolarPowderItem extends ShinyMaterialModElements.ModElement {
	@ObjectHolder("shiny_material:solar_powder")
	public static final Item block = null;

	public SolarPowderItem(ShinyMaterialModElements instance) {
		super(instance, 29);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Powerful Powder"));
		}
	}
}
