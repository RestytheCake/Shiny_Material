...
public class SolarDustItem extends ShinyMaterialModElements.ModElement {
	@ObjectHolder("shiny_material:solar_dust")
	public static final Item block = null;

	public SolarDustItem(ShinyMaterialModElements instance) {
		super(instance, 2);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Powerful Dust"));
		}
	}
}
