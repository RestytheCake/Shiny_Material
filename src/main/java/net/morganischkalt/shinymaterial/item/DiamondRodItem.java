...
public class DiamondRodItem extends ShinyMaterialModElements.ModElement {
	@ObjectHolder("shiny_material:diamond_rod")
	public static final Item block = null;

	public DiamondRodItem(ShinyMaterialModElements instance) {
		super(instance, 19);
	}
