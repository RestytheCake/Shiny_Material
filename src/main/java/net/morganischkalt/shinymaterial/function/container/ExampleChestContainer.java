package net.morganischkalt.shinymaterial.function.container;
...
public class ExampleChestContainer extends AbstractContainerMenu {
    ...
    public ExampleChestContainer(int id, Inventory playerInv, IItemHandler slots, BlockPos pos) {
        super(Container.EXAMPLE_CHEST.get(), id);
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.containerAccess, player, Block.EXAMPLE_CHEST.get());
    }
