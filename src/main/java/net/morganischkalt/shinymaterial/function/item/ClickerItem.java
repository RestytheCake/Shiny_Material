package net.morganischkalt.shinymaterial.function.item;
...
public class ClickerItem extends Item {
    ...
    public boolean isFoil(ItemStack stack) {
        ...
        return nbt.contains(ShinyMaterial.MODID, Tag.TAG_COMPOUND)
                && nbt.getCompound(net.morganischkalt.shinymaterial.ShinyMaterial.MODID).contains("ContainedBlock", Tag.TAG_COMPOUND);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!stack.getOrCreateTag().contains(net.morganischkalt.shinymaterial.ShinyMaterial.MODID, Tag.TAG_COMPOUND)) {
            stack.getOrCreateTag().put(net.morganischkalt.shinymaterial.ShinyMaterial.MODID, new CompoundTag());
            return InteractionResultHolder.fail(stack);
        }

        final CompoundTag nbt = stack.getOrCreateTag().getCompound(net.morganischkalt.shinymaterial.ShinyMaterial.MODID);
